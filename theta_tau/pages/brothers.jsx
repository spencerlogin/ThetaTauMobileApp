  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <SafeAreaView>
            ...
            <Brother style={styles.brother} bio={BrotherData.brotherData[20].description} linkedin={BrotherData.brotherData[20].linkedin} name="Daniel Galdamez" title="" imageSource ={require("../assets/daniel_galdamez.png")}/>
            <Brother style={styles.brother} bio={BrotherData.brotherData[21].description} linkedin={BrotherData.brotherData[21].linkedin} name="Jeffrey Kou" title=""  imageSource = {require('../assets/jeffrey_kou.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[22].description} linkedin={BrotherData.brotherData[22].linkedin} name="Andrew Li" title=""  imageSource = {require('../assets/andrew_li.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[23].description} linkedin={BrotherData.brotherData[23].linkedin} name="Victor Lin" title=""  imageSource = {require('../assets/victor.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[24].description} linkedin={BrotherData.brotherData[24].linkedin} name="Myles Pauquette" title=""  imageSource = {require('../assets/myles.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[25].description} linkedin={BrotherData.brotherData[25].linkedin} name="Juan Quintero" title=""  imageSource = {require('../assets/juan.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[26].description} linkedin={BrotherData.brotherData[26].linkedin} name="Adrian Sin" title=""  imageSource = {require('../assets/adrian_sin.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[27].description} linkedin={BrotherData.brotherData[27].linkedin} name="Justin Siwa" title=""  imageSource = {require('../assets/justin_siwa.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[28].description} linkedin={BrotherData.brotherData[28].linkedin} name="Alex Yevzerov" title=""  imageSource = {require('../assets/alex_yev.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[29].description} linkedin={BrotherData.brotherData[29].linkedin} name="Zachary Clark" title=""  imageSource = {require('../assets/zachary.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[30].description} linkedin={BrotherData.brotherData[30].linkedin} name="Lydia Cenac" title=""  imageSource = {require('../assets/lydia.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[31].description} linkedin={BrotherData.brotherData[31].linkedin} name="Aryaman Ghosh" title="" imageSource ={require("../assets/aryaman_ghosh.png")}/>
            <Brother style={styles.brother} bio={BrotherData.brotherData[32].description} linkedin={BrotherData.brotherData[32].linkedin} name="James Henry" title=""  imageSource = {require('../assets/jph.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[33].description} linkedin={BrotherData.brotherData[33].linkedin} name="Anna Kane" title=""  imageSource = {require('../assets/anna_kane.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[34].description} linkedin={BrotherData.brotherData[34].linkedin} name="Isabella Nguyen" title=""  imageSource = {require('../assets/bella.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[35].description} linkedin={BrotherData.brotherData[35].linkedin} name="Rrucha Singh" title=""  imageSource = {require('../assets/rrucha_singh.png')} />
            <Brother style={styles.brother} bio={BrotherData.brotherData[36].description} linkedin={BrotherData.brotherData[36].linkedin} name="Jenny Zhu" title=""  imageSource = {require('../assets/jenny.png')} />
