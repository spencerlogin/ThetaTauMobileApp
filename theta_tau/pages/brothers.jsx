    ...
    <ScrollView>
      <View style={styles.outside}>
        ...
        <SafeAreaView>
            ...
            <Brother style={styles.brother} name="David Zaretsky" title=""  imageSource = {require('../assets/manvir.png')} />
            ...
            <Brother style={styles.brother} name="Andrew Li" title=""  imageSource = {require('../assets/manvir.png')} />
